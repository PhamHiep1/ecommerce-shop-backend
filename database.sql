...
--khách hàng khi muốn mua hàng -> phải có tài khoản--> tạo bảng users
CREATE TABLE users(
...
--Bảng dang mục sản phẩm
CREATE TABLE categories(
    id INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'Tên danh mục, vd: Đồ điện tử'
);

--Bảng chứa sản phẩm(Product): "laptop macbook air 15 inch 2025"
CREATE TABLE products(
    id INT PRIMARY KEY AUTO_INCREMENT,
    product_name VARCHAR(350)  COMMENT 'Tên sản phẩm',
...
--xóa 1 đơn hang =>xóa mềm => thêm trường active
ALTER TABLE orders ADD COLUMN active TINYINT(1);
--Trạng thái đơn hàng chỉ được phép nhận một sô giá trị cụ thể
ALTER TABLE orders
